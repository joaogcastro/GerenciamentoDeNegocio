...
public class VendedorNovaFesta {
    public static void venderFesta (){
        ...
        if(CPFUtils.validarCPF(cliente.getCpf())==true){
            ...
            festa.setDataInicio(LocalDateTimeReader.readLocalDateTime("Informe a data de início (no formato dd/MM/yyyy HH:mm): "));
            festa.setDataFim(LocalDateTimeReader.readLocalDateTime("Informe a data do fim (no formato dd/MM/yyyy HH:mm): "));
